      ...
      <div className="container pt-6 pb-14">
        ...
        {modal && (
          <div className="absolute shadow-2xl bg-bg2 w-1/2 flex flex-col justify-center items-center p-4 transition-all duration-700 sub-container">
            ...
            <button
              type="button"
              className="btn btn-primary bg-gradient-to-b from-primary to-blue-500 w-100 my-15 fs-16 float-right"
        ...
        >
          ...
          <button className="btn btn-primary font-bold text-lg bg-gradient-to-b from-primary to-blue-500 self-start">
            Sign Up
          </button>
        </form>
      </div>
